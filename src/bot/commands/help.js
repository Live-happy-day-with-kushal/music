    ...
    run: async function(client, message, args, user) {
        try {
            ...
            let help = new MessageEmbed()
                ...
                .setDescription(`🎶 | Rexom is a first music bot using [discord-buttons](https://discord-buttons.js.org/) to control the bot and the bot have very advanced commands to play you music from all song pads, make you own bot [from here](https://discord.gg/Tkw5CvQ8un)`);
